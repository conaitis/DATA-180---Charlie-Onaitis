...
```{r}
ggplot(data=Cars93, aes(x=EngineSize, y=MPG.city)) + geom_point(size=2, col="blue") + xlim(1,6) + ylim(0,50) + labs(title = "Scatterplot of Engine Size and MPG", x="Engine Size", y="MPG")
```
...
```{r}
ggplot(data=Cars93, aes(x=EngineSize, y=MPG.city, col=Type)) + geom_point(size=2) + xlim(1,6) + ylim(0,50) + labs(title = "Scatterplot of Engine Size and MPG", x="Engine Size", y="MPG")
```
...
```{r}
ggplot(data=Cars93, aes(x=EngineSize, y=MPG.city, col=Type)) + geom_point(size=2) + xlim(1,6) + ylim(0,50) + labs(title = "Scatterplot of Engine Size and MPG", x="Engine Size", y="MPG") + geom_smooth(linetype="dashed", col="red")
```
...
```{r}
ggplot(data=Cars93, aes(AirBags)) + geom_bar(fill = c(1,2,3)) +labs(title = "Barplot of Airbags", x="Airbags", y="# of Airbags" , caption="Barplot of Airbags") 
```
...
```{r}
ggplot(data=Cars93, aes(x=Origin, fill=AirBags)) + geom_bar(position="dodge") +labs(title = "Barplot of Origin", x="Origin", y="# of Origins" , caption="Barplot of Origins") 
```
...
```{r}
ggplot(data=au_states) + geom_sf() + geom_point(data=au_capitals, size=2, col="red", aes(x=lon, y=lat))
```
...
```{r}
ggplot(data=au_states) + geom_sf() + geom_point(data=au_capitals, size=2, col="red", aes(x=lon, y=lat)) + coord_sf(crs =st_crs(3112))
```
...
```{r}
mapview(au_states) + mapview(capitals_geo, legend=F, col.region="red")
```
